...
Set positionsListBGEE[30]=79
Set positionsListBGEE[31]=80
Set positionsListBGEE[32]=81
Set positionsListBGEE[33]=82 
...
for /F "tokens=2 delims==" %%l in ('Set languages[') do ( 
	...
	for /L %%j in (0,1,!countedFiles!) do ( 
		...
		Set /a count=0
		for %%g IN (b c d a 8 9 g_ h_ l m e n o p q r f g h 0 k_ l_ i j k 0_ 1_ 2_ 3_ w s t u v) DO (
